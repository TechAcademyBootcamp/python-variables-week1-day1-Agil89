...
galloon = int(input('enter galloons:'))
print('litres:',galloon*3.7854)
print('barels:',galloon/19.5)
print('CO2:',galloon*20)
print('Etanol:',galloon*115000/75700)
print('Price:',galloon*4)